...
export const ConvexSVG = ({ ...props }: React.ComponentProps<"svg">) => {
  return (<svg width="184" height="188" viewBox="0 0 184 188" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
